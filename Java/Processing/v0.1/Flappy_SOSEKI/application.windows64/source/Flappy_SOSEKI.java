...
public class Flappy_SOSEKI extends PApplet {
...
float SysMAX= 5.5f;  // SOSEKI Y MAX speed
float GA = 0.04f;  // Gravity acceleration
...
public void score() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Flappy_SOSEKI" };
    if (passedArgs != null) {
